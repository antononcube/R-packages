  ...
  reactive({
    smrObj() %>%     
      SMRMonApplyTagTypeWeights( 
        weights = 
          c( 
            TitleVector = input$titleVectorTagTypeWeight,
            SkillsVector = input$skillsVectorTagTypeWeight,
            AcronymVector = input$acronymVectorTagTypeWeight,
            KeywordVector = input$keywordVectorTagTypeWeight
          ), 
        default = 1 ) %>% 
