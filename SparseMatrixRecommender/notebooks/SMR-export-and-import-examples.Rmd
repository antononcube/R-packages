...
smrTitanic$M <- SMRApplyTermWeightFunctions( smrTitanic$M, "IDF", "None", "Cosine" )
```
...
```{r}
SMRExportToDirectory( smr = smrTitanic, directoryPath = "../SMR-export", dataNameInfix = "Titanic" )
```
...
```{r}
smrTitanic2 <- SMRImportFromDirectory( directoryPath = "../SMR-export", dataNameInfix = "Titanic" )
```
