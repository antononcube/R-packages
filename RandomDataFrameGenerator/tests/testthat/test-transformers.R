...
test_that("Variables split", {
                     ...
                     RandomDataFrame(
                       ...
                       generators =
                         list(
                           ...
                           Cuisine = c("Chinese", "Finnish", "Turkish", "Greek", "Scandinavian"),
  ...
  expect_s3_class( object = dfRand2 <- SplitVariableValues( data = dfRand, splitPattern = ";", variableToSplit = "Ingredient", valueColumn = "Value.character" ), "data.frame" )

  expect_equal( nrow(dfRand2), nrow(dfRand) + numberOfItems * (numberOfIngredients - 1) )
