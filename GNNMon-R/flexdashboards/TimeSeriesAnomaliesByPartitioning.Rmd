---
title: "Time series anomalies by partitioning"
output: 
...
The time series anomalies are identified by partitioning the time series into overalapping blocks 
and using `GNNMon`, [AAp1], to classify the those parts as anomalous or not.

The financial and temperature time series are obtained through the data package MathematicaVsR, [AAp3].
