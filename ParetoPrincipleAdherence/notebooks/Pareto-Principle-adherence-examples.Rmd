...
```{r}
plot(ParetoForNumericalVector(trees$Height))
```


```{r}
ParetoPlotForColumns(data = diamonds, columnNames = c("carat", "price") )
```

```{r}
ParetoPlotForColumns(data = diamonds, columnNames = c("cut", "color", "clarity"), scales = "free" )
```
