...
```{r}
shiny::runApp( TSCorrSMRCreateSearchInterface( tsSMR = tssmrSP500, initNNs = 6, initNCols = 2, roundDigits = 4, plotOutputHeight = "800px", dashboardTitle = "S&P 500 search engine", theme = "slate" ) )
```
```{r}
library(magrittr)
