...
```{r}
shiny::runApp( TSCorrSMRCreateSearchInterface( tsSMR = tssmrSP500, initNNs = 6, initNCols = 2, roundDigits = 4, plotOutputHeight = "600px", dashboardTitle = "S&P 500 search engine") )
```
```{r}
library(magrittr)
